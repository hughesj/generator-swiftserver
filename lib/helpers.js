...
exports.codableHandlerName = function (method, typelist) {
  let newtypes = typelist.map(t => {if (t[1]) { return 'arrayOf' + t[0]}; return t[0]})
  let name = newtypes.reduce((pre, elem) => {return pre + elem })
