...
exports.codableHandlerNameInsert = function (detail, count) {
  // Return a name insert comprised from the input and output types.
  ...
  if (detail.method === 'delete') {
    name = 'Handler' + count[detail.method][detail.variant].toString()
  } else {
    name = name + '_Handler' + count[detail.method][detail.variant].toString()
  }
  // increment the count
